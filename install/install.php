...
?>';
	...
	('dateFormat', 'n/j/y', '0', 'The date format to use on the board', 'general', ".$timestamp."),
	('timeFormat', 'g:ia', '0', 'The time format to use on the board', 'general', ".$timestamp."),
	...
	(1, 1, ".$timestamp.", 'Congratulations, BetaDev Board installed successfully.')";
	$queries[] =
